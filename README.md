...
| 文件 | 输入大小 | Archive 大小 | bpb | 严格 roundtrip |
|---|---:|---:|---:|---|
| `dickens` | 10,192,446 B | 2,134,355 B | 1.675245 | PASS |
| `mozilla` | 51,220,480 B | 7,082,696 B | 1.106229 | PASS |
| `mr` | 9,970,564 B | 1,964,351 B | 1.576120 | PASS |
| `nci` | 33,553,445 B | 915,279 B | 0.218226 | PASS |
| `ooffice` | 6,152,192 B | 1,428,445 B | 1.857478 | PASS |
| `osdb` | 10,085,684 B | 2,120,697 B | 1.682144 | PASS |
| `reymont` | 6,627,202 B | 853,403 B | 1.030182 | PASS |
| `samba` | 21,606,400 B | 1,979,660 B | 0.732990 | PASS |
| `sao` | 7,251,944 B | 3,767,793 B | 4.156450 | PASS |
| `webster` | 41,458,703 B | 5,458,288 B | 1.053248 | PASS |
| `x-ray` | 8,474,240 B | 3,576,943 B | 3.376768 | PASS |
| `xml` | 5,345,280 B | 272,795 B | 0.408278 | PASS |
